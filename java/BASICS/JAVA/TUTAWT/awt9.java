...
class awt9 extends Frame{
	...
	public static void main(String agrs[]){
		...
		Mainmenu.addActionListener (new awt9menulistener());
		...
		awt9 sampframe = new awt9("frame window");
		...
		sampframe.addMouseListener(new awt9listener());
		System.out.println("after adding listener");
		//let us do something intresting here
		b1.addMouseListener(new awt9listener());
		//let us add a listener to b2 button also
		b2.addMouseListener(new awt9listener());
		}
...
class awt9listener implements MouseListener{
...
class awt9menulistener implements ActionListener {
