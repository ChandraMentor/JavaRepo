...
This program demonstrates how to add a menu to  main window and also
shows how to respond to menu clicks
Author : Team -J
Version : 1.0 
*/
import java.awt.*;
...
class awt10 extends Frame{
	...
	public static void main(String agrs[]){
		...
		Mainmenu.addActionListener (new awt10menulistener());
		...
		awt10 sampframe = new awt10("frame window");
		...
		sampframe.addMouseListener(new awt10listener());
		System.out.println("after adding listener");
		//let us do something intresting here
		b1.addMouseListener(new awt10listener());
		//let us add a listener to b2 button also
		b2.addMouseListener(new awt10listener());
...
class awt10listener implements MouseListener{
...
/* class implementing actionlistener for Menu click*/
class awt10menulistener implements ActionListener {
public void actionPerformed(ActionEvent e){
	 System.out.println("menu item " + e.getActionCommand() + "  selected");
	}
}
