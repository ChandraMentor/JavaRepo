...
This program demonstrates how to use a seperate class to implement 
an event listner
to mouse events.
Author : Team -J
Version : 1.0 
...
class awt6 extends Frame{
	...
	public static void main(String agrs[]){
		 Button b1,b2;
		awt6 sampframe = new awt6("frame window");
